...
/*
   ...
   Задача: 
            ...
            Получить от пользователя числа A и D.
            Сформировать массив по формуле:
                a[i] = A + i * D;
            Вывести массив.
*/

namespace Task03Page18
{
    class Program
    {
        ...
        /// <summary>
        /// Forms array using formula: a[i] = A + i * D;.
        /// </summary>
        /// <param name="array">Array.</param>
        /// <param name="A">A.</param>
        /// <param name="D">D.</param>
        static void FormArray(int[] array, int A, int D)
        {
            for (int i = 0; i < array.Length; i++)
                array[i] = A + i * D;
        }
        ...
        static void Main()
        {
            do
            {
                ...
                int n = InputVar("size of array (2 - 1000)", 2, 1000, (x, y) => x < y, (x, y) => x > y);
                int A = InputVar("integer A (-1000 - 1000)", -1000, 1000, (x, y) => x < y, (x, y) => x > y);
                int D = InputVar("integer D (-1000 - 1000)", -1000, 1000, (x, y) => x < y, (x, y) => x > y);
