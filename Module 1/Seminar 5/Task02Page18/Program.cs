...
/*
   ...
   Задача: 
            Получить от пользователя число N - размер массива. Заполнить массив нечетными числами от 1.
            Вывести массив.
*/

namespace Task02Page18
{
    class Program
    {
        ...
        /// <summary>
        /// Fills array wtih odd numbers from 1 to 2 * N - 1.
        /// </summary>
        /// <param name="array">Array.</param>
        static void FillArrayWithOdds(int[] array)
        {
            for (int i = 0; i < array.Length; i++)
                array[i] = 2 * i + 1;
        }
        ...
        static void Main()
        {
            do
            {
                ...
                int n = InputVar("size of array (1 - 1000)", 1, 1000, (x, y) => x < y, (x, y) => x > y);
