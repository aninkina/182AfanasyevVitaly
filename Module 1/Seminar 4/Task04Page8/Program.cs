...
/*
   ...
   Задача: 
            Вычислить значение выражения 2^N + 2^M.
            N, M – целые неотрицательные числа вводятся пользователем с клавиатуры. 
            Используйте битовые операции для организации «быстрого умножения». 
            Помните о возможности переполнения.
*/

namespace Task04Page8
{
    ...
    class Program
    {
        ...
        /// </summary>
        /// <returns>2 powered to N.</returns>
